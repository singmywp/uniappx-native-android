...
open class GenUniModulesSinleUiComponentsSnCheckboxTagSnCheckboxTag : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesSinleUiComponentsSnCheckboxTagSnCheckboxTag, _arg1: SetupContext) -> Any? = fun(
        @Suppress("UNUSED_ANONYMOUS_PARAMETER")
        __props, ref1): Any? {
            var __expose = ref1.expose;
            val __ins = getCurrentInstance()!!;
            val _ctx = __ins.proxy as GenUniModulesSinleUiComponentsSnCheckboxTagSnCheckboxTag;
            ...
            return fun(): Any? {
                ...
                return createVNode(_component_sn_tag, utsMapOf("ref_key" to "tagEle", "ref" to tagEle, "text" to _ctx.text, "bgColor" to unref(bgColorC), "textColor" to unref(textColorC), "textSize" to unref(tagTextSize), "customTextStyle" to unref(customTextStyle), "customStyle" to _ctx.customStyle, "onClick" to checkboxClicked, "style" to normalizeStyle(utsArrayOf(
                    unref(tagStylesC),
